...
app.get('/favicon.ico', async (req, res) => {
  try {
    ...
    const [config] = await masterQuery(
      `SELECT tc.logo_url, tc.favicon_url FROM tenants t
